...
(function() {
  var debug, extend, headerStringToObject,
    slice = [].slice;
  ...
  headerStringToObject = exports.headerStringToObject = function(headerString) {
    var filteredList, list;
    list = headerString.split('\n');
    filteredList = list.filter(function(keyAndValue) {
      return !!keyAndValue;
    });
    return filteredList.reduce(function(acc, keyAndValue) {
      var splitKey;
  ...
  exports.normalizeXhrResponse = function(xhr) {
    return {
